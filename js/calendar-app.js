    ...
    document.getElementById('lyb-main').innerHTML = `
      <div class="lyb-main-content">
        <div class="lyb-calendar-container">
          ...
          <div class="lyb-calendar-actions">
            <div class="lyb-dropdown">
              <button class="lyb-btn lyb-btn-primary lyb-action-btn" id="lyb-add-calendar-main">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <button class="lyb-btn lyb-btn-secondary lyb-action-btn" id="lyb-whatsapp-share" style="background:#25D366!important;color:#fff!important;border:none!important">
