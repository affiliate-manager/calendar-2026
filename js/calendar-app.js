...
class LandlordYearbook {
    ...
    document.getElementById('lyb-main').innerHTML = `
      <div class="lyb-main-content">
        ...
        <div class="lyb-sidebar">
          ...
          <button class="lyb-btn lyb-btn-secondary lyb-sidebar-btn" id="lyb-whatsapp-share" style="background:#25D366!important;color:#fff!important;border:none!important">
  ...
  updateEventCard() {
    ...
    content.innerHTML = `
      ...
      <div class="lyb-card-section lyb-expert-section" style="background-image:url('${expert.image}')">
